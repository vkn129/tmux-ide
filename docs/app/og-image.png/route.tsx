  ...
  return new ImageResponse(
    (
      ...
      >
          ...
          <div style={{ display: 'flex', height: '240px', gap: '1px' }}>
            ...
            >
              ...
              <div style={{ padding: '10px 14px', fontSize: '12px' }}>
                <div style={{ color: '#999' }}>$ claude --team my-app</div>
            ...
            >
              ...
              <div style={{ padding: '10px 14px', fontSize: '12px' }}>
                <div style={{ color: '#666' }}>$ claude --teammate-mode</div>
        ...
        >
          <span style={{ fontSize: '42px', fontWeight: 'bold', color: '#fff', letterSpacing: '-1px' }}>
            tmux-ide
          </span>
