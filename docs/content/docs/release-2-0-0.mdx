...
tmux-ide 2.0 transforms from a terminal IDE into an autonomous multi-agent development platform, inspired by Factory's Droid Missions. Define a mission, and agents self-organize through milestones, validation, and skill-based dispatch.
